...
@interface BaseView ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
- (void)showFontSelectorWithCompletionHandler:(SuccessBlock)completionHandler {
    ...
    NSArray *sortByStrings = [fonts sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)];
