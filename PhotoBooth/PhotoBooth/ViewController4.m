...
//  PhotoBooth
//
//  Created by Rob Enriquez on 11/20/16.
...
@interface ViewController4 () <AWCameraViewDelegate>
...
- (void)setupLabels {
    ...
    self.imageViewPreview2.transform = CGAffineTransformMakeRotation(-3.14f/6);
